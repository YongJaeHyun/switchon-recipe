...
export const allNotices = [
  {
    ...
    changes: [
      ...
      '🍱 통밀또띠아, 올리브, 블루베리, 통밀파스타면, 가자미, 우엉, 옥수수, 병아리콩, 닭다리살, 홀그레인 머스타드, 황태, 치아씨드, 루꼴라, 반숙란, 스리라차소스 추가',
    ],
  ...
  },
  {
    ...
    changes: [
      ...
      '🍱 연두부, 아몬드파우더, 올리브유, 양송이버섯, 껍질콩(그린빈), 곤약밥, 시오콘부 추가',
    ],
